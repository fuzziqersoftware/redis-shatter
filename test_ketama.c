...
int main(int argc, char* argv[]) {
...

  {
    ...
    ketama_continuum* c = ketama_create_continuum(NULL, 0, NULL);
...

  {
    ...
    ketama_continuum* c = ketama_create_continuum(NULL, 1, hosts);
...

  {
    ...
    ketama_continuum* c = ketama_create_continuum(NULL, 3, hosts);
...

  {
    ...
    ketama_continuum* c = ketama_create_continuum(NULL, 2, hosts);
...

  {
    ...
    const char* hosts[3] = {"host1:8080", "host2:8080", "host3:8080"};
    ketama_continuum* c1 = ketama_create_continuum(NULL, 3, hosts);
    ketama_continuum* c2 = ketama_create_continuum(NULL, 2, hosts); // host3 was removed
